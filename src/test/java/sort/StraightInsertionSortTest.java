...
public class StraightInsertionSortTest {
    ...
    @BeforeMethod
    public void setUp() {
        System.out.println("The StraightInsertionSort is started");
    ...
    public void tearDown() {
        System.out.println("The StraightInsertionSort is done");
        array = null;
        target_array = null;
    }
    ...
    public void testInsertSort() {
        ...
        array_temp = StraightInsertionSort.insertSort(array);
